package com.example.swappedcolumnoffset
...
import com.example.swappedcolumnoffset.ui.theme.SwappedColumnOffsetTheme
...
@Composable
fun SampleTexts(
    modifier: Modifier = Modifier, fontColor: Color = Color.Unspecified
) {
    val textCount = 20
    repeat(textCount) {
        Text(
